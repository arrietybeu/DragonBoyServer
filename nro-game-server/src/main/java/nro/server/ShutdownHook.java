...
import nro.server.config.main.ShutdownConfig;
...
//                // if remainingSeconds got updated from another thread
        ...
        ServerManager.shutdownNioServer(); // shuts down nro.utils.test.network, disconnects cs/ls/all players and saves them
