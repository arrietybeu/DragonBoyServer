...
import nro.commons.configuration.transformers.MapTransformer;
...
public class ConfigurableProcessor {
    ...
    public static Set<String> process(java.util.Properties properties, Object... objectsOrClasses) {
     ...
     */
    private static void process(Class<?> clazz, Object obj, java.util.Properties props, Set<String> unusedProperties) {
     ...
     * @param props Properties with keys\values
     */
    private static void processFields(Class<?> clazz, Object obj, java.util.Properties props, Set<String> unusedProperties) {
        for (Field f : clazz.getDeclaredFields()) {
            ...
            if (f.isAnnotationPresent(Property.class) || f.isAnnotationPresent(nro.commons.configuration.Properties.class)) {
    ...
    private static void processField(Field f, Object obj, java.util.Properties props, Set<String> unusedProperties) {
        boolean oldAccessible = f.canAccess(obj);
        try {
            if (!oldAccessible)
                f.setAccessible(true);
            Property property = f.getAnnotation(Property.class);
            nro.commons.configuration.Properties properties = f.getAnnotation(nro.commons.configuration.Properties.class);
            if (property != null) {
                if (properties != null)
    ...
    private static Map<String, String> filterProperties(Pattern pattern, java.util.Properties props, Set<String> unusedProperties) {
    ...
    private static String getValue(String key, String defaultValue, java.util.Properties props, Set<String> unusedProperties) {
