...
import nro.commons.configuration.TransformationException;
...
public abstract class PropertyTransformer<T> {
     ...
     * @param type            the declared class for the value (hint to the transformer which class to instantiate - not mandatory, therefore implementation specific)
     * @param genericTypeArgs the generic type of the given class
